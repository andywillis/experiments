 ...
 * This is separate from the Venda namespace as it carries functions required
 * to get the namespace up and running.
 * @requires jQuery.
 * 0503013 AJW
 */
...
;(function() {
  ...
  /**
   * Applies a template to a data object to produce HTML.
   ...
   */
  util.HTMLSupport = {
    localStorage: (typeof window !== 'undefined' && 'localStorage' in window.localStorage !== null) ? true : false,
    sessionStorage: (typeof window !== 'undefined' && 'sessionStorage' in window.sessionStorage !== null) ? true : false,
    file: (typeof window !== 'undefined' && 'File' in window.File !== null) ? true : false
  };
